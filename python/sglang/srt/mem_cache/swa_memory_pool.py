...
class SWAKVPool(KVCache):
    ...
    def translate_loc_from_full_to_swa(self, kv_indices: torch.Tensor):
        ...
        # Direct index lookup without OOB check (the check forces GPU->CPU sync
        # via .any() which costs ~1ms per call × 5000 calls = 5 seconds overhead).
        # The mapping already has a -1 sentinel at the end for kv_indices == -1.
